 ...
 *       &lt;attribute name="crncyCd" use="required" type="{http://www.w3.org/2001/XMLSchema}short" /&gt;
 *       &lt;attribute name="amntDue" use="required" type="{br/com/vivo/spn/integration/schema/consulta/SolicitacaoInformacaoClienteContaPosPagoResponse}decimal2" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Currency {
    ...
    @XmlAttribute(name = "crncyCd", required = true)
    protected short crncyCd;
    @XmlAttribute(name = "amntDue", required = true)
     ...
     * 
     */
    public void setCrncyCd(short value) {
        this.crncyCd = value;
    }
